...
> For further explanation on this script, visit the [README](https://github.com/tarranprior/DevOps/tree/main/Azure/Scripting/PowerShell/Active-Directory/Generate_Users/README.md).
