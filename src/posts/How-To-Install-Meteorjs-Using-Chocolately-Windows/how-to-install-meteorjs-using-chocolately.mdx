...
To confirm that Chocolatey is working, type `choco` or `choco -?` and you'll see the following output:
...
If you're having any trouble installing Chocolatey using the methods above, see the [Troubleshooting](https://docs.chocolatey.org/en-us/troubleshooting) section at Chocolatey.
...
## Further Resources
So what's next? *Meteor is your oyster!* 🦪 For pointers, I've included a handful of resources below.

- [An Introduction To Meteorjs - Quick Start Guide](http://localhost:8000/writing/an-introduction-to-meteorjs-quick-start-guide)
