...
## Contents
0. [Update System](#update-system)
1. [Remove Existing Versions of Go](#remove-existing-versions-of-go)
2. [Downloading Go](#downloading-go)
3. [Set The $PATH Variables](#set-the-path-variables)
