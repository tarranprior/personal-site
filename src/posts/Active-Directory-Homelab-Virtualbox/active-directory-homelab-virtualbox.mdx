...
1. [Setup & Installation of Windows Server](#Setup-Installation-of-Windows-Server)
2. [Installing VirtualBox Guest Additions](#Installing-VirtualBox-Guest-Additions)
3. [Configuring Server Network Adapters](#Configuring-Server-Network-Adapters)
4. [Installing Active Directory Domain Services](#Installing-Active-Directory-Domain-Services)
5. [Create Domain Administrator Account](#Create-Domain-Administrator-Account)
6. [Installing & Configuring RAS/NAS](#Installing-Configuring-RAS-NAT)
7. [Installing & Configuring DHCP Server](#Installing-Configuring-DHCP-Server)
8. [Disable Internet Browsing Security Configuration](#Disable-Internet-Browsing-Security-Configuration)
9. [PowerShell Automation & Scripting](#PowerShell-Automation-Scripting)
10. [Setting Up Windows 10 User Environment](#Setting-Up-Windows-10-User-Environment)
