---
title: "Active Directory Homelab Using Local Virtualisation & PowerShell Automation"
author: "Tarran Prior"
date: "2022-06-18 17:15"
slug: "active-directory-homelab-using-virtualisation-powershell-automation"
edit: "2022-06-24 08:19"
reading: "14 min"
...
**Active Directory** is a management solution that stores, organises and provides access to information about users, devices, files and more (referred to as *objects*) in a system network. This allows system administrators to directly manage and configure thousands of users/devices from a centralised location.
...
0. [Prerequisites](#prerequisites)
    ...
    - [Downloading Windows 10 Enterprise (Evaluation)](#-windows-10-enterprise-evaluation)
    - [Downloading Windows Server 2019 (Evaluation)](#-windows-server-2019-evaluation)
1. [Setup & Installation of Windows Server](#1---setup--installation-of-windows-server)
2. [Installing VirtualBox Guest Additions](#2---installing-virtualBox-guest-additions)
3. [Configuring Server Network Adapters](#3---configuring-server-network-adapters)
4. [Installing Active Directory Domain Services](#4---installing-active-directory-domain-services)
5. [Create Domain Administrator Account](#5---create-domain-administrator-account)
6. [Installing & Configuring RAS/NAS](#6---installing--configuring-ras-nat)
7. [Installing & Configuring DHCP Server](#7---installing--configuring-dhcp-server)
8. [Disable Internet Browsing Security Configuration](#8---disable-internet-browsing-security-configuration)
9. [PowerShell Automation & Scripting](#9---powerShell-automation--scripting)
10. [Setting Up Windows 10 User Environment](#10---setting-up-windows-10-user-environment)
...
- **RAM**: 2 GB +
- **HDD**: 100 GB + of available free disk space (*2 x* 50 GB +).
...
### 📦 VirtualBox
You can download the latest version of VirtualBox [here](https://www.virtualbox.org/wiki/Downloads), or use the link below.
...
**Step 1**: In *Service Manager*, select "*Add roles and features*." Click next until you get to get to "*Select server roles*."
...
### Namelists
To begin, you'll need to download [this list](https://github.com/tarranprior/active-directory-powershell/tree/main/AD-Generate_Users/names.txt) of randomly generated names.

> This list was generated using Python and a collection of 📜 [Wordlists](https://github.com/tarranprior/wordlists).

### PowerShell Script
In addition, download this PowerShell script [here](https://github.com/tarranprior/active-directory-powershell/tree/main/AD-Generate_Users/generate-users.ps1) (don't forget to leave a star! ⭐) or you can copy the script below and paste in it a text editor, saving as `generate-users.ps1`.)
...
> Download a [zip]() with both files.<br />
> For further explanation on this script, visit the [README](https://github.com/tarranprior/active-directory-powershell/tree/main/AD-Generate_Users/README.md).

<br />

**Step 1**: Once you have both files, copy them over to your virtual machine. Create a new folder in a directory of your choice to store the files.

> To save yourself some time, just download them directly to your virtual machine.<br />
